class PeteSql:
	def __init__(self):
		...
		self._queries = ["""update "<orig_table>" set acreage    = null where acreage    like '';"""]
		self._queries.append("""update "<orig_table>" set lotdepthft = null where lotdepthft like '';""")
		self._queries.append("""update "<orig_table>" set lotfrontft = null where lotfrontft like '';""")

		#-- create _v2 table copying table structure of original table

		self._queries.append("""create table "<out_table>" (like "<orig_table>" including all);""")

		#-- modify implied decimal text fields of _v2 table to FLOAT

		self._queries.append("""alter table "<out_table>" 
		...
		self._queries.append("""insert into "<out_table>" 
			(
				fips,
				state,
				postal,
		...
		self._queries.append("""update "<out_table>"  set lotdepthft = lotdepthft/10;
		...
		self._queries.append("""vacuum analyze "<out_table>";""")
